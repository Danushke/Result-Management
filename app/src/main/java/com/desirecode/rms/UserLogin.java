...
public class UserLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register=findViewById(R.id.t_v_register);
        ...
        editTextUsername=findViewById(R.id.e_t_login_username);
        editTextPassword=findViewById(R.id.e_t_login_password);
    ...
    private void userLogin(){
        ...
        if( TextUtils.isEmpty(username) ||TextUtils.isEmpty(password)) {
            ...
            StringRequest stringRequest = new StringRequest(
                    Request.Method.POST,
                    Constant.URL_LOGIN,
                    //"http://192.168.43.20/result/Android/v1/userLogin.php",
                                ...
                                if (!object.getBoolean("error")) {
                                    ...
                                    SharedPrefManager.getInstance(getApplicationContext())
                                            .userLogin(
                                                    ...
                                                    object.getInt("index"),
                                                    object.getString("short name"),
                                                    object.getString("table name"),
